...
This file provides guidance to GitHub Copilot (and other AI coding agents) when working with code in
this repository.

> **Source of truth:** the authoritative project instructions live in [`CLAUDE.md`](./CLAUDE.md)
> (originally written for Claude Code). This file mirrors the same content for tools that read
> `AGENTS.md` instead. If the two files ever diverge, treat `CLAUDE.md` as canonical and update this
> file to match.
