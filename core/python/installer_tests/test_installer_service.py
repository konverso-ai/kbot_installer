...
class TestInstallerService:
    ...
    @patch("installer_support.installer_service.create_provider")
    ...
    def test_load_products_from_repository_success(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with (
                ...
                patch(
                    "installable.product_installable.ProductInstallable.from_installer_folder"
                ) as mock_from_folder,
                patch("shutil.rmtree"),
            ):
                # Setup mocks
    ...
    def test_install_success_with_dependencies(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with (
                ...
                patch(
                    "installer_support.installer_service.ensure_directory"
                ) as mock_ensure,
            ):
                # Test
    ...
    def test_list_products_as_tree(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with (
                ...
                patch(
                    "installer_support.installer_service.DependencyGraph",
                    return_value=mock_graph,
                ),
                patch(
                    "installer_support.installer_service.DependencyTreeRenderer",
    ...
    def test_repair_single_product(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with (
                patch(
                    "installer_support.installer_service.shutil.rmtree"
                ) as mock_rmtree,
    ...
    def test_load_products_from_installer_directory_success(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with patch(
                "installer_support.installer_service.ProductCollection.from_installer",
                return_value=mock_collection,
            ):
                # Test
