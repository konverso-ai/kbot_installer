...
class NexusFiles(list):
    ...
    def Filter(self, folder_name=None, name=None, ends_with=None, not_ends_with=None, folder_starts_with=None, contains=None):
        ...
        if contains:
            files = [x for x in files if contains in x.path]
