...
from versioner.gitpython_versioner import GitPythonVersioner
...
class TestGitPythonVersioner:
    ...
    def test_clone_success(self, versioner_without_auth) -> None:
        ...
        with patch(
            "versioner.gitpython_versioner.Repo.clone_from"
        ) as mock_clone:
    ...
    def test_checkout_remote_branch_success(self, versioner_without_auth) -> None:
        ...
        with patch(
            "versioner.gitpython_versioner.Repo"
        ) as mock_repo_class:
            mock_repo = MagicMock()
    ...
    def test_check_remote_repository_exists_success(
        ...
        with patch(
            "versioner.gitpython_versioner.git.cmd.Git"
        ) as mock_git_class:
            mock_git = MagicMock()
