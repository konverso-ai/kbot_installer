...
class TestDependencyGraph:
    ...
    def test_initialization_with_products(self) -> None:
        ...
        product1 = create_installable("product", name="test1", version="1.0.0", type="solution")
        product2 = create_installable("product", name="test2", version="2.0.0", type="framework")
    ...
    def test_str_representation(self) -> None:
        ...
        product = create_installable("product", name="test", version="1.0.0", type="solution")
