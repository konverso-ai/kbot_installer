...
def _product(
    ...
    """Build a Product with the given name, version, type and parents."""
    return Product(
        name=name,
        version=version,
        type=type_,
...
class TestDependencyGraph:
    ...
    def test_initialization_with_products(self) -> None:
        ...
        product1 = _product("test1", "1.0.0", "solution")
        product2 = _product("test2", "2.0.0", "framework")
    ...
    def test_build_graph_simple(self) -> None:
        ...
        product1 = _product("test1", "1.0.0", "solution", parents=["test2"])
        product2 = _product("test2", "2.0.0", "framework", parents=[])
        graph = DependencyGraph([product1, product2])
    ...
    def test_build_graph_complex(self) -> None:
        ...
        product1 = _product("test1", "1.0.0", "solution", parents=["test2", "test3"])
        product2 = _product("test2", "2.0.0", "framework", parents=["test3"])
        product3 = _product("test3", "3.0.0", "library", parents=[])
    ...
    def test_has_circular_dependency_true(self) -> None:
        ...
        product1 = _product("test1", "1.0.0", "solution", parents=["test2"])
        product2 = _product("test2", "2.0.0", "framework", parents=["test1"])
        graph = DependencyGraph([product1, product2])
    ...
    def test_has_circular_dependency_complex(self) -> None:
        ...
        product1 = _product("test1", "1.0.0", "solution", parents=["test2"])
        product2 = _product("test2", "2.0.0", "framework", parents=["test3"])
        product3 = _product("test3", "3.0.0", "library", parents=["test1"])
        graph = DependencyGraph([product1, product2, product3])
    ...
    def test_get_root_products(self) -> None:
        ...
        # Root products are those with no dependents
        assert "test3" in roots or len(roots) == 0

    def test_get_leaf_products(self) -> None:
        """Test getting leaf products (no dependencies)."""
        product1 = _product("test1", "1.0.0", "solution", parents=["test2"])
        product2 = _product("test2", "2.0.0", "framework", parents=["test3"])
        product3 = _product("test3", "3.0.0", "library", parents=[])
        graph = DependencyGraph([product1, product2, product3])
        ...
        # Leaf products are those with no dependencies
    ...
    def test_str_representation(self) -> None:
        ...
        product = _product("test", "1.0.0", "solution")
