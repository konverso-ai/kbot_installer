"""SSH credentials for Bitbucket, based on local keys or a forwarded agent."""

from credentials.ssh_utils import ssh_auth_kwargs, ssh_missing_env_vars


class SshBitbucketCredentials:
    """Bitbucket credentials satisfied by a local SSH key or ``SSH_AUTH_SOCK``."""
