...
class TestAzureVault:
    ...
    def test_azure_vault_get_value_with_valid_key(
        self, mock_credential, mock_client_class, key: str, expected: str
    ) -> None:
    ...
    @pytest.mark.parametrize(
        "invalid_key",
        ["", None, "simple_key_without_double_colon", "key:single_colon", "vault::"],
    )
    def test_azure_vault_get_value_with_invalid_key(
    ...
    @patch("kbot_installer.core.vault.azure_vault.SecretClient")
    @patch("kbot_installer.core.vault.azure_vault.DefaultAzureCredential")
    def test_azure_vault_set_value(
        self,
        mock_credential,
        mock_client_class,
        key: str,
    ...
    @patch("kbot_installer.core.vault.azure_vault.SecretClient")
    @patch("kbot_installer.core.vault.azure_vault.DefaultAzureCredential")
    def test_azure_vault_delete_value(
        self, mock_credential, mock_client_class, key: str | None, *, expected: bool
    ) -> None:
